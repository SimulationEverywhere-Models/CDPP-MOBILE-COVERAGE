...
[Movement]
rule : 0 100 { (0,0,2) = 10 } %No need to caculate movement because no BS cover this cell.
...
rule : 0 100 { (0,0,-1) != 1 or (0,0,0) != 6 } 
rule : 0 100 { (0,0,-1) != 0 or (0,-1,-1) != 1 or (0,-1,0) != 2 }
rule : 0 100 { (0,0,-1) != 0 or (-1,0,-1) != 1 or (-1,0,0) != 3 }
rule : 0 100 { (0,0,-1) != 0 or (0,1,-1) != 1  or (0,1,0) != 4  }
rule : 0 100 { (0,0,-1) != 0 or (1,0,-1) != 1  or (1,0,0) != 5  }

[SigStrUE]
rule : 0 100 { (0,0,1) = 10 } %No need to caculate movement because no BS cover this cell.
rule : 0 100 { (0,0,-2) = 0 and (0,-1,-1) != 2 and (-1,0,-1) != 3 and (0,1,-1) != 4 and (1,0,-1) != 5 }

rule : 0 100 { (0,0,-2) = 1 and (0,0,-1) = 2 and (0,1,-2) = 0 }
rule : 0 100 { (0,0,-2) = 1 and (0,0,-1) = 3 and (1,0,-2) = 0 and ((1,-1,-2) = 0 or (1,-1,-1) != 2) }
rule : 0 100 { (0,0,-2) = 1 and (0,0,-1) = 4 and (0,-1,-2) = 0 and ((0,-2,-2) = 0 or (0,-2,-1) != 2) and ((-1,-1,-2) = 0 or (-1,-1,-1) != 3) }
rule : 0 100 { (0,0,-2) = 1 and (0,0,-1) = 5 and (-1,0,-2) = 0 and ((-1,-1,-2) = 0 or (-1,-1,-1) != 2) and ((-2,0,-2) = 0 or (-2,0,-1) != 3) and ((-1,1,-2) = 0 or (-1,1,-1) != 4) }
